...
class StockPipeline:
    ...
    def run_acquisition(self, tickers: List[str], 
        ...
        try:
            fetch_stock_data(tickers, start_date, end_date, self.raw_dir)
    ...
    def run_anomaly_detection(self) -> Dict:
        ...
        try:
            ...
            for file in os.listdir(self.processed_dir):
                if file.startswith('processed_'):
                    file_path = os.path.join(self.processed_dir, file)
                    results = run_anomaly_detection(file_path, anomaly_dir)
                    anomaly_results[file] = results
    ...
    def run_pipeline(self, tickers: List[str], 
        ...
        try:
            ...
            self.run_acquisition(tickers, start_date, end_date)
